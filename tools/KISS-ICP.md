...
**File:** `~/miniconda3/envs/kiss/lib/python3.10/site-packages/kiss_icp/tools/visualizer.py`
...
- `--visualize` opens the 3D polyscope window; omit to run headless (faster)
...
> The point cloud map is **not** saved automatically. Only poses are saved.
